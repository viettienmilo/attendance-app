...
về những hệ thống thông tin quản lý khác nhau, cũng như phân tích và thiết kế hệ thống, quy 
trình xây dựng, thu thập, xử lý, tổ chức dữ liệu.`,
  intro2: `Tìm hiểu các giai đoạn của hệ thống thông tin và một số hệ thống cần thiết cho doanh 
nghiệp, áp dung HTTTQL vào doanh nghiệp trong quá trình hoạch định chiến lược, tổ chức, giám sát, 
cập nhật và nâng cấp HTTT theo quá trình phát triển của doanh nghiệp.`,
  intro3: `Làm nền tảng và cơ sở giúp sinh viên chọn được hệ thống thông tin thích hợp cho doanh 
nghiệp cụ thể và triển khai được tiến trình nào doanh nghiệp cần thực hiện.`,
  intro4: `Môn học HTTTQL có nội dung bao gồm trong 07 chương được được hướng dẫn với thời lượng 
  ...
  lesson_contents: [
    ...
    },
    {
      'Chương 6': [
        ...
        `HTTTQL Chuỗi cung ứng (Supply-Chain Information Management System)`,
        `HTTTQL Hoạch định nguồn lực doanh nghiệp (Enterprise Resource Planning Information Management System)`,
        `HTTTQL Tri thức (Knowledge Information Management System)`,
      ],
    },
    {
      'Chương 7': [
